...
std::unique_ptr<geometry_msgs::msg::PointStamped> RLController::createCarrotMsg(
...
double RLController::getLookAheadDistance(const geometry_msgs::msg::Twist & speed)
{
...
bool RLController::shouldRotateToPath(
...
bool RLController::shouldRotateToGoalHeading(
  const geometry_msgs::msg::PoseStamped & carrot_pose)
{
...
void RLController::rotateToHeading(
...
bool RLController::isCollisionImminent(
...
bool RLController::inCollision(const double & x, const double & y)
{
  unsigned int mx, my;
...
double RLController::costAtPose(const double & x, const double & y)
{
  unsigned int mx, my;
  costmap_->worldToMap(x, y, mx, my);
...
void RLController::applyConstraints(
...
PLUGINLIB_EXPORT_CLASS(
  nav2_rl_controller::RLController,
